...
if(isset($_SESSION["logged_in"]) && $_SESSION["temp"] == 0 ){
	...
	echo"<div class=\"hub_nav\">
		<div class=\"tab\" id=\"tab_A\" tabindex=\"0\">
			Research Topics<a href=\"prof_add_research_topic_form.php\"> Add </a>
		</div>
		...
		<div class=\"tab\" id=\"tab_B\">
			Events <a href=\"prof_add_event_form.php\"> Add </a> 
		</div>
		...
		<div class=\"tab\" id=\"tab_C\">
			Bulletin Board Topics <a href=\"prof_add_board_topic_form.php\"> Add </a>
		</div>
		...
		<div class=\"tab\" id=\"tab_D\">
			Equipment<a href=\"prof_add_equipment_form.php\"> Add </a> 
		</div>
		...
		<div class=\"tab\" id=\"tab_E\">
			Procedures<a href=\"prof_add_procedure_form.php\"> Add </a> 
		</div>
		...
		<div class=\"tab\" id=\"tab_F\">
			Downloads <a href=\"prof_add_download_form.php\"> Add </a> 
		</div>
		
		<div class=\"hub_display\" id=\"display_F\">
			";
		...
		<div class=\"tab\" id=\"tab_G\">
			FAQ <a href=\"prof_add_faq_form.php\"> Add </a> 
		</div>
		
		<div class=\"hub_display\" id=\"display_G\">
			";
		include_once "list_faqs.php";
